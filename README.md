...
![nlw-ia](https://github.com/Rodrigo001-dev/nlw-ia/assets/59906558/5965a6ae-cafa-4b2a-a918-7153ec2e64ae)

> Nesse projeto o objetivo criar um titulo ou descrição de um vídeo, é realizado o upload do vídeo e ocorre uma conversão do vídio para MP3 com isso esse aúdio é enviado para api da OpenAI e essa api me devolve o título ou descrição desse audio
...
```bash
# Clone o Repositório
$ git@github.com:Rodrigo001-dev/nlw-ia.git
```
